...
const Header = () => {
  ...
  return (
    <div className="flex items-center justify-around border-b-2 h-[10vh] sm:h-auto border-white bg-[#101010] ">
      <div>
        <Link to={"/"}>
          <img
            className="sm:w-[9vw] w-[50%] "
      ...
      <div className="flex items-center w-[60%] sm:w-auto flex-wrap">
        <select
          className="mr-7 bg-transparent text-white"
          name="laguage"
